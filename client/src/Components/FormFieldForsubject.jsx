...
const FormFieldForsubject = ({
  ...
  const clearHandler =()=>{
    ...
    setForm({ name: '', prompt: '', output: '' , keywords: ''});
    ...
    <div >
     ...
     <div className="flex flex-col gap-3 mt-3">
      <label
        ...
        id={value.keywords}
        name="keywords"
        placeholder="enter a keywords: discounts, beachwear, vacation, sun"
...
export default FormFieldForsubject;
